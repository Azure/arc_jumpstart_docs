...
- [Azure Bastion](/azure_arc_jumpstart/azure_arc_data/aks/aks_mssql_mi_arm_template/#connect-using-azure-bastion) - available if ```true``` was the value of your _`deployBastion`_ parameter during deployment.
