...
- [RDP](/azure_arc_jumpstart/azure_edge_iot_ops/aks_edge_essentials_single_akri/#connecting-directly-with-rdp) - available after configuring access to port 3389 on the _Arc-Win-Demo-NSG_, or by enabling [Just-in-Time access (JIT)](/azure_arc_jumpstart/azure_edge_iot_ops/aks_edge_essentials_single_akri/#connect-using-just-in-time-access-jit).
- [Azure Bastion](/azure_arc_jumpstart/azure_edge_iot_ops/aks_edge_essentials_single_akri/#connect-using-azure-bastion) - available if ```true``` was the value of your _`deployBastion`_ parameter during deployment.
