...
* First bash script ([_edge_azure_vm.sh_](https://github.com/microsoft/azure_arc/blob/main/azure_arc_k8s_jumpstart/aks_iot_edge/terraform/scripts/edge/edge_azure_vm.sh) - Used specifically for provisioning the necessary components in the VM to be able to deploy our "simulated" edge device:
...
* Second bash script ([_az_k8sconfig_helm_aks.sh_](https://github.com/microsoft/azure_arc/blob/main/azure_arc_k8s_jumpstart/aks_iot_edge/terraform/scripts/helm/az_k8sconfig_helm_aks.sh) Allow us to deploy our IoT Edge solution for AKS, configure our and associate our AKS cluster with Azure Arc, for this:
