...
- Open the Azure portal and navigate to the resource group "Arc-Servers-Demo". The virtual machine created in AWS will be visible as a resource.
    ...
    ![Screenshot showing the Azure portal and Azure Arc-enabled server](./10.png)
...
- When complete, your VM will be registered with Azure Arc and visible in the resource group inside the Azure portal.
