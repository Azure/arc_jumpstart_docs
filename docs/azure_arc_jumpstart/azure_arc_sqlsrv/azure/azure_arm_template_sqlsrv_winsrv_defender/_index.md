...
> **Note:** Occasionally Microsoft Defender for SQL may not detect SQL threats generated by the simulation script file *testDefenderForSQL.ps1* executed during the Client VM logon and will not receive an alert email as documented in this scenario. If this happens follow steps under **Simulate Microsoft Defender for SQL threats** below to re-generate threats and receive an alert email.
