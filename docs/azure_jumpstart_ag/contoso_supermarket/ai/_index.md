...
In the next scenario, learn how Contoso Supermarket are streamlining the [Software Delivery Process using CI/CD](/azure_jumpstart_ag/contoso_supermarket/ci_cd/).
